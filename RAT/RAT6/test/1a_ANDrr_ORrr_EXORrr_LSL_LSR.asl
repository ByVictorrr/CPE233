...
(0140)  CS-0x084  0x10600         || LSL R6
(0141)  CS-0x085  0x3061F         || CMP R6, 0X1F
(0142)  CS-0x086  0x0844B         || BRNE timedelay4
(0143)                            || 
(0144)  CS-0x087  0x23408         || OR R20,  BIT_3_MASK
(0145)  CS-0x088  0x35440         || OUT R20, LED_PORT
(0146)                            || 
(0147)  CS-0x089  0x371AA  0x089  || timedelay4:    MOV     R17, OUTSIDE_FOR_COUNT  
(0148)  CS-0x08A  0x2D101  0x08A  || outside_for4: SUB     R17, 0x01
(0149)                            || 
(0150)  CS-0x08B  0x372CA         ||              MOV     R18, MIDDLE_FOR_COUNT   
(0151)  CS-0x08C  0x2D201  0x08C  || middle_for4:  SUB     R18, 0x01
(0152)                            ||              
(0153)  CS-0x08D  0x373B4         ||              MOV     R19, INSIDE_FOR_COUNT   
(0154)  CS-0x08E  0x2D301  0x08E  || inside_for4:  SUB     R19, 0x01
(0155)  CS-0x08F  0x08473         ||              BRNE    inside_for4
(0156)                            ||              
(0157)  CS-0x090  0x23200         ||              OR      R18, 0x00              
(0158)  CS-0x091  0x08463         ||              BRNE    middle_for4
(0159)                            ||              
(0160)  CS-0x092  0x23100         ||              OR      R17, 0x00               
(0161)  CS-0x093  0x08453         ||              BRNE    outside_for4
(0162)                            || 
(0163)                            || ;---------------------------------------------------------------
(0164)  CS-0x094  0x04709  0x094  || LSRTest:MOV R7, R1
(0165)                            || CMPR10, R11
            syntax error
            syntax error

(0166)  CS-0x095  0x10701         || LSR R7
(0167)  CS-0x096  0x30787         || CMP R7, 0X87
(0168)  CS-0x097  0x084D3         || BRNE timedelay5
(0169)                            || 
(0170)  CS-0x098  0x23410         || OR R20,  BIT_4_MASK
(0171)  CS-0x099  0x35440         || OUT R20, LED_PORT
(0172)                            || 
(0173)  CS-0x09A  0x371AA  0x09A  || timedelay5:    MOV     R17, OUTSIDE_FOR_COUNT  
(0174)  CS-0x09B  0x2D101  0x09B  || outside_for5: SUB     R17, 0x01
(0175)                            || 
(0176)  CS-0x09C  0x372CA         ||              MOV     R18, MIDDLE_FOR_COUNT   
(0177)  CS-0x09D  0x2D201  0x09D  || middle_for5:  SUB     R18, 0x01
(0178)                            ||              
(0179)  CS-0x09E  0x373B4         ||              MOV     R19, INSIDE_FOR_COUNT   
(0180)  CS-0x09F  0x2D301  0x09F  || inside_for5:  SUB     R19, 0x01
(0181)  CS-0x0A0  0x084FB         ||              BRNE    inside_for5
(0182)                            ||              
(0183)  CS-0x0A1  0x23200         ||              OR      R18, 0x00              
(0184)  CS-0x0A2  0x084EB         ||              BRNE    middle_for5
(0185)                            ||              
(0186)  CS-0x0A3  0x23100         ||              OR      R17, 0x00               
(0187)  CS-0x0A4  0x084DB         ||              BRNE    outside_for5
(0188)                            || 
(0189)                            || ;---------------------------------------------------------------
(0190)                            || LightLEDs:ORR20, 0xE0
            syntax error
            syntax error
            syntax error

(0191)  CS-0x0A5  0x35440         || OUT R20, LED_PORT
(0192)                            || 
(0193)                            || ;---------------------------------------------------------------
(0194)  CS-0x0A6  0x37F00  0x0A6  || endless_loop:MOV R31, 0x00
(0195)                            || 
            syntax error
...
INSIDE_FOR4    0x08E   (0154)  ||  0155 
INSIDE_FOR5    0x09F   (0180)  ||  0181 
LSLTEST        0x083   (0138)  ||  
LSRTEST        0x094   (0164)  ||  
