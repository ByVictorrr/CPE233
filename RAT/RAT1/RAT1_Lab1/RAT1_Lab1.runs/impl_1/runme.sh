...
HD_PWD='/home/victor/CPE233/RAT/RAT1/RAT1_Lab1/RAT1_Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgRom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProgRom.tcl -notrace
