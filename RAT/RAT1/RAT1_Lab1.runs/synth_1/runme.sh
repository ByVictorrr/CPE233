...
HD_PWD='/home/victor/CPE233/RAT/RAT1/RAT1_Lab1/RAT1_Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgRom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProgRom.tcl
