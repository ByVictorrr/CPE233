...
HD_PWD='C:/Users/vdelapla/Desktop/RAT1_SV/RAT1_SV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgRom_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProgRom_tb.tcl -notrace
