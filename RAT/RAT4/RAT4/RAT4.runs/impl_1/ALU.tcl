...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache ./.Xil/Vivado-31047-TheShell/incrSyn
  create_project -in_memory -part xc7a35tcpg236-1
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
  set_property webtalk.parent_dir /home/victor/CPE233/RAT/RAT4/RAT4/RAT4.cache/wt [current_project]
  set_property parent.project_path /home/victor/CPE233/RAT/RAT4/RAT4/RAT4.xpr [current_project]
  set_property ip_output_repo /home/victor/CPE233/RAT/RAT4/RAT4/RAT4.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet /home/victor/CPE233/RAT/RAT4/RAT4/RAT4.runs/synth_1/ALU.dcp
