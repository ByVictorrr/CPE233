...
HD_PWD='/home/victor/CPE233/PER/PER3/PER3/PER3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Keypad_Diver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Keypad_Diver.tcl
