...
HD_PWD='/home/victor/CPE233/PER/PER3/PER3/PER3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Keypad_Diver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Keypad_Diver.tcl -notrace
