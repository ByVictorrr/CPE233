...
(0016)                            || ; R2 - for the index of the number begin outputed (index  = SP_START-1) 
...
(0030)  CS-0x002  0x04301         || 	MOV R3, R0
...
(0042)                            || 	
(0043)                            || 
(0044)  CS-0x009  0x2C201  0x009  || output_2:	SUB R2, 1 ; R2 = SP_START - 1
(0045)                            || 
(0046)                            || 		; When R2 == SP_START end program
(0047)  CS-0x00A  0x30100         || 		CMP R1, 0 
(0048)                            || 		; if z == 1 { count == 0 } 
(0049)                            || 		; else z==0 { count != 0 }
(0050)  CS-0x00B  0x08082         || 		BREQ done
(0051)                            || 		;else if R2 != SP_START
(0052)  CS-0x00C  0x04312         || 		LD R3, (R2) ; res = arr[index]
(0053)  CS-0x00D  0x34342         || 		OUT R3, OUT_PORT 
(0054)  CS-0x00E  0x2C101         || 		SUB R1, 1	
(0055)  CS-0x00F  0x08048         || 		BRN output_2 
(0056)                     0x010  || done: 
...
-- Labels
------------------------------------------------------------ 
DONE           0x010   (0056)  ||  0050 
INC_PUSH       0x005   (0037)  ||  
MAIN           0x001   (0028)  ||  0039 
OUTPUT_1       0x008   (0041)  ||  0034 
OUTPUT_2       0x009   (0044)  ||  0055 
...
OUT_PORT       0x042   (0021)  ||  0053 
SP_START       0x000   (0022)  ||  0041 
