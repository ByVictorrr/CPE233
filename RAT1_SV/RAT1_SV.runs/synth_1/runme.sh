...
HD_PWD='C:/Users/vdelapla/Desktop/RAT1_SV/RAT1_SV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgRom_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProgRom_tb.tcl
